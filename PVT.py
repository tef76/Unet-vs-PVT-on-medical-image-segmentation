...
class PyramidVisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=5, embed_dims=[64, 128, 320, 512],
        ...
        self.upsample5 = nn.ConvTranspose2d(32, num_classes, 4, stride=2, padding=1) 
